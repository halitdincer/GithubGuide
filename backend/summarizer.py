...
def clone_repository(repo_url, target_directory):
    try:
        ...
        print(f'Successfully deleted the folder: {target_directory}')
    except Exception as e:
        print(f'Error deleting folder: {target_directory}\n{e}')
...
def setup(repo_url):
    ...
    for code in codes:
        ...
        try:
            ...
            print(f"{code_file_path} IS NOT CACHED ... continue with OpenAI")
